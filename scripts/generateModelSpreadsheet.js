...
async function generateModelSpreadsheet() {
  ...
  const COLORS = {
    darkNavy: 'FF0F172A',     // #0F172A (Slate 900)
    darkSlate: 'FF1E293B',    // #1E293B (Slate 800)
    mediumSlate: 'FF334155',  // #334155 (Slate 700)
    mutedSlate: 'FF475569',   // #475569 (Slate 600)
    lightSlate: 'FF94A3B8',   // #94A3B8 (Slate 400)
    borderSlate: 'FFE2E8F0',  // #E2E8F0 (Slate 200)
    cardBorder: 'FFCBD5E1',   // #CBD5E1 (Slate 300)
    surfaceBg: 'FFF8FAFC',    // #F8FAFC (Slate 50)
    cardHeaderBg: 'FFF1F5F9', // #F1F5F9 (Slate 100)
    white: 'FFFFFFFF',
    ...
    borderGreen: 'FF10B981',

    amberBg: 'FFFEF3C7',      // #FEF3C7 (Amber 100)
    amberText: 'FF92400E',    // #92400E (Amber 800)
    amberBorder: 'FFF59E0B',  // #F59E0B (Amber 500)

    roseBg: 'FFFEF2F2',       // #FEF2F2 (Rose 50)
    roseText: 'FF991B1B',     // #991B1B (Rose 800)
    roseBorder: 'FFEF4444'    // #EF4444 (Rose 500)
  };

  const thinBorder = {
    top: { style: 'thin', color: { argb: COLORS.borderSlate } },
    bottom: { style: 'thin', color: { argb: COLORS.borderSlate } },
    left: { style: 'thin', color: { argb: COLORS.borderSlate } },
    right: { style: 'thin', color: { argb: COLORS.borderSlate } }
  };

  // ===========================================================================
  // ABA 1: PEDIDO COMERCIAL (Aba Principal)
  // ===========================================================================
  const ws1 = workbook.addWorksheet('PEDIDO COMERCIAL', {
    views: [{ showGridLines: true }]
  });

  // Configuração das 16 colunas
  ws1.columns = [
    { key: 'colA', width: 6 },   // #
  ...
  // Banner Informativo de Orientação
  ...
  ws1.getRow(4).height = 6; // Espaçador
  ...
  ws1.getRow(11).height = 6; // Espaçador
  ...
  // Linha 13: Número do Pedido, Datas, Frete e Pagamento
  ...
  // Linha 14: % Nota e Observações de Descarga
  ...
  ws1.getRow(15).height = 10; // Espaçador

  // ===========================================================================
  // TABELA DE ITENS (Cabeçalho Linha 16)
  // ===========================================================================
  const tableHeaders = [
    { title: '#', align: 'center', width: 6 },
    { title: 'CÓDIGO FORNECEDOR', align: 'center', width: 18 },
    { title: 'CÓDIGO INTERNO (PRD)', align: 'center', width: 18 },
    { title: 'CÓDIGO BARRAS (EAN-13)', align: 'center', width: 18 },
    { title: 'DESCRIÇÃO DO PRODUTO', align: 'left', width: 44 },
    { title: 'NCM', align: 'center', width: 13 },
    { title: 'UNID.', align: 'center', width: 9 },
    { title: 'QTD/CX', align: 'center', width: 11 },
    { title: 'QTD CX', align: 'center', width: 12 },
    { title: 'TOTAL PEÇAS', align: 'center', width: 15 },
    { title: 'PREÇO UNIT. (R$)', align: 'right', width: 16 },
    { title: '% IPI', align: 'center', width: 10 },
    { title: 'VALOR IPI (R$)', align: 'right', width: 15 },
    { title: 'VALOR TOTAL (R$)', align: 'right', width: 17 },
    { title: 'PDV SUGERIDO (R$)', align: 'right', width: 16 },
    { title: 'MARGEM BRUTA (%)', align: 'right', width: 15 },
  ];
  ...
  // ===========================================================================
  // LINHA DE TOTAIS DA TABELA COMERCIAL
  // ===========================================================================
  ...
  currentLine++;
  ws1.getRow(currentLine).height = 12; // Espaçador
  currentLine++;

  // ===========================================================================
  // BLOCO DE REGRAS MANDATÓRIAS E CARD DE RESUMO FINAL
  // ===========================================================================
  const blockStart = currentLine;

  // Header Regras Mandatórias (A..J)
  ...
  // Card Gigante de Total Geral Líquido + IPI
  ...
  // ===========================================================================
  // ABA 2: SEPARAÇÃO POR LOJA (20 Lojas Rede Mega 12)
  // ===========================================================================
  ...
  const STORES_LIST = [
    // Cluster A (8 Lojas)
    { id: 'pg_centro', name: 'Ponta Grossa Centro', cluster: 'A' },
    { id: 'reserva', name: 'Reserva', cluster: 'A' },
    { id: 'tibagi', name: 'Tibagi', cluster: 'A' },
    { id: 'nova_russia', name: 'Nova Rússia', cluster: 'A' },
    { id: 'javert', name: 'Javert', cluster: 'A' },
    { id: 'ivai', name: 'Ivaí', cluster: 'A' },
    { id: 'irati_centro', name: 'Irati Centro', cluster: 'A' },
    { id: 'campo_largo', name: 'Campo Largo', cluster: 'A' },
    // Cluster B (8 Lojas)
    { id: 'castro', name: 'Castro', cluster: 'B' },
    { id: 'imbituva', name: 'Imbituva', cluster: 'B' },
    { id: 'santa_paula', name: 'Santa Paula', cluster: 'B' },
    { id: 'prudentopolis', name: 'Prudentópolis', cluster: 'B' },
    { id: 'guarapuava', name: 'Guarapuava', cluster: 'B' },
    { id: 'imbau', name: 'Imbaú', cluster: 'B' },
    { id: 'rio_azul', name: 'Rio Azul', cluster: 'B' },
    { id: 'reboucas', name: 'Rebouças', cluster: 'B' },
    // Cluster C (4 Lojas)
    { id: 'deposito_central', name: 'Depósito Central', cluster: 'C' },
    { id: 'teixeira_soares', name: 'Teixeira Soares', cluster: 'C' },
    { id: 'mallet', name: 'Mallet', cluster: 'C' },
    { id: 'ipiranga', name: 'Ipiranga', cluster: 'C' },
  ];

  // Configuração das colunas de Separação
  ws2.columns = [
    { key: 'sColA', width: 6 },   // #
    { key: 'sColB', width: 16 },  // CÓDIGO FORNECEDOR
    { key: 'sColC', width: 16 },  // CÓDIGO INTERNO
    { key: 'sColD', width: 38 },  // DESCRIÇÃO
    { key: 'sColE', width: 14 },  // TOTAL DO PEDIDO
    { key: 'sColF', width: 12 },  // RESERVA CD
    // 20 lojas
    ...STORES_LIST.map(st => ({ width: 14 })),
    { width: 15 }, // TOTAL ALOCADO
    { width: 16 }, // STATUS DIVERGÊNCIA
  ];
  ...
  // Linha de agrupamento de Clusters (Linha 3)
  ...
  ws2.getCell('O3').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FF0D9488' } }; // Teal 600
  ws2.getCell('O3').alignment = { vertical: 'middle', horizontal: 'center' };

  // Cluster C (Col W a Z = 4 lojas)
  ...
  ws2.getCell('W3').fill = { type: 'pattern', pattern: 'solid', fgColor: { argb: 'FF0284C7' } }; // Sky 600
  ws2.getCell('W3').alignment = { vertical: 'middle', horizontal: 'center' };

  // Auditoria (Col AA e AB)
  ...
  const sepHeaders = [
    ...
    ...STORES_LIST.map(s => s.name.toUpperCase()),
  ...
  // Gravação do arquivo Excel físico
  const targetPath = path.resolve(__dirname, '..', 'Planilha_Modelo_Importacao_Pedido_Mega12.xlsx');
  await workbook.xlsx.writeFile(targetPath);
  console.log(`✅ Planilha modelo gerada com sucesso em: ${targetPath}`);

  return targetPath;
}

generateModelSpreadsheet()
  .then(() => process.exit(0))
  .catch(err => {

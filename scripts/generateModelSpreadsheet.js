...
async function generateModelSpreadsheet() {
  ...
  // Linha 14: % OFF, % Nota e Observações de Descarga
  ...
  const tableHeaders = [
    ...
    { title: 'PREÇO UNIT. (R$)', align: 'right', width: 18 },
  ];
  ...
  const fieldsGuide = [
    ...
    { name: 'PREÇO UNIT. (R$)', req: 'SIM', tipo: 'Moeda (R$)', desc: 'Preço unitário líquido de compra da peça negociado com o fornecedor.' },

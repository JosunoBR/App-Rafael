        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {(activeNav === 'separation' || activeNav === 'orders') && order?.header?.numeroPedido && (
                <span className="px-2.5 py-0.5 rounded-lg bg-emerald-600 text-white font-mono text-xs font-extrabold shadow-xs tracking-tight flex items-center gap-1">

...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200/80 dark:border-slate-800 flex flex-col justify-between shrink-0 h-screen sticky top-0 transition-colors z-30 overflow-y-auto select-none">
        ...
        <div className="p-3 space-y-4">
          ...
          <div className="space-y-1">
            ...
            {canAccessSuppliers && (
              ...
              >
                <div className="flex items-center gap-2.5">
                  <Building2 className={`w-4 h-4 ${activeNav === 'suppliers' ? 'text-white' : 'text-emerald-400'}`} />
                  <span>Fornecedores & ST</span>
                </div>
      ...
      {/* 3. Rodapé da Barra Lateral: Usuário & Alternador de Tema */}
      <div className="p-3 border-t border-slate-200/80 dark:border-slate-800 space-y-2 bg-slate-50/50 dark:bg-slate-900/50">
        ...
        {currentUser && (
          <div className="p-2 rounded-xl bg-white dark:bg-slate-800/80 border border-slate-200/60 dark:border-slate-700/60 flex items-center justify-between shadow-2xs">

...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const [isCollapsed, setIsCollapsed] = useState<boolean>(() => {
    try {
      return localStorage.getItem('mega12_sidebar_collapsed') === 'true';
    } catch {
      return false;
    }
  });
  ...
  const toggleCollapsed = () => {
    setIsCollapsed(prev => {
      const next = !prev;
      try {
        localStorage.setItem('mega12_sidebar_collapsed', String(next));
      } catch {
        // ignore
      }
      return next;
          ...
          >
            ...
            {!isCollapsed && (
              <div className="min-w-0">
                <h1 className="text-base font-black text-slate-900 dark:text-white tracking-tight leading-none truncate">
